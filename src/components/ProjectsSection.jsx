...
const projects = [
  {
    ...
    description: 'Designed a multi-agent AI pipeline (Extractor → Analyst → Researcher → Critic) analysing freelance contracts across 10 legal risk categories with grounded, auditable outputs. Implemented a RAG pipeline using Pinecone vector DB and the CUAD legal dataset for semantic, precedent-based clause retrieval; used LlamaParse for structured ingestion of complex legal PDFs.',
